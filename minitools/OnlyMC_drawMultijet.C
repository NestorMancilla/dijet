...
string version = "v38_Summer23MG_NoL2L3Res_Off_reweight_jets_test";
...
void drawMultijets(string epoch, string version) {
    ...
    //TFile *fm = new TFile("/Users/nestorma/Documents/Helsinki/dijet/rootfiles/");
    //TFile *fm = new TFile("/Users/nestorma/Documents/Helsinki/dijet/rootfiles/v38_Summer23MG_NoL2L3Res_Off_reweight_jets_test/jmenano_mc_cmb_Summer23MG_test_v38_Summer23MG_NoL2L3Res_Off_reweight_jets_test.root");
    TFile *fm = new TFile(Form("/Users/nestorma/Documents/Helsinki/dijet/rootfiles/%s/jmenano_mc_cmb_Summer23MG_test_%s.root",cv,cv));
    ...
    c1->SaveAs(Form("/Users/nestorma/Documents/Helsinki/dijet/rootfiles/pdf/%s/drawMultijet/drawMultijet_%s_%s.pdf",cv,ce,cv));
    //c1->SaveAs(Form("/media/storage/nestorma/dijet/rootfiles/pdf/v37_Summer23MG_NoL2L3Res/drawMultijet/drawMultijet_%s_%s.pdf",ce,cv));
} // drawMultijet
