...
// Fixed size dimensions of array or collections stored in the TTree if any.
  ...
  //Float_t         btagWeight_DeepCSVB;
   ...
   Float_t         ChsMET_phi; //Prompt 2024 data
   Float_t         ChsMET_pt; //Prompt 2024 data
   //Float_t         ChsMET_sumEt; //Prompt 2024 data
  ...
  //Int_t           LowPtElectron_electronIdx[11];   //[nLowPtElectron]
   ...
   Float_t         GenMET_phi;
   Float_t         GenMET_pt;
   //Float_t         MET_MetUnclustEnUpDeltaX; //Prompt 2024 data
   //Float_t         MET_MetUnclustEnUpDeltaY; //Prompt 2024 data
   //Float_t         MET_covXX; //Prompt 2024 data
   //Float_t         MET_covXY; //Prompt 2024 data
   //Float_t         MET_covYY; //Prompt 2024 data
   //Float_t         MET_phi; //Prompt 2024 data
   Float_t         MET_pt; //Prompt 2024 data
   //Float_t         MET_significance; //Prompt 2024 data
   Float_t         MET_sumEt; //Prompt 2024 data
   //Float_t         MET_sumPtUnclustered; //Prompt 2024 data
   Int_t           nMuon;
  ...
  //Float_t         Photon_z_calo[8];   //[nPhoton]
   ...
   //Float_t         PuppiMET_phiJERDown; //Prompt 2024 data
   //Float_t         PuppiMET_phiJERUp; //Prompt 2024 data
   //Float_t         PuppiMET_phiJESDown; //Prompt 2024 data
   //Float_t         PuppiMET_phiJESUp; //Prompt 2024 data
   Float_t         PuppiMET_phiUnclusteredDown;
   Float_t         PuppiMET_phiUnclusteredUp;
   Float_t         PuppiMET_pt;
   //Float_t         PuppiMET_ptJERDown; //Prompt 2024 data
   //Float_t         PuppiMET_ptJERUp; //Prompt 2024 data
   //Float_t         PuppiMET_ptJESDown; //Prompt 2024 data
   //Float_t         PuppiMET_ptJESUp; //Prompt 2024 data
   Float_t         PuppiMET_ptUnclusteredDown;
   Float_t         PuppiMET_ptUnclusteredUp;
   Float_t         PuppiMET_sumEt;
   //Float_t         RawMET_phi; //Prompt 2024 data
   //Float_t         RawMET_pt; //Prompt 2024 data
   //Float_t         RawMET_sumEt; //Prompt 2024 data
   Float_t         RawPuppiMET_phi;
   Float_t         RawPuppiMET_pt;
   Float_t         RawPuppiMET_sumEt; // Prompt 2024 data, to reduce possible noise. Nestor.
  ...
  //UChar_t         Tau_idDeepTau2018v2p5VSmu[5];   //[nTau]
   //Float_t         TkMET_phi; //Prompt 2024 data
   //Float_t         TkMET_pt; //Prompt 2024 data
   //Float_t         TkMET_sumEt; //Prompt 2024 data
  ...
  //TBranch        *b_btagWeight_DeepCSVB;   //!
   ...
   TBranch        *b_ChsMET_phi;   //! //Prompt 2024 data
   TBranch        *b_ChsMET_pt;   //! //Prompt 2024 data
   //TBranch        *b_ChsMET_sumEt;   //! //Prompt 2024 data
  ...
  //TBranch        *b_LowPtElectron_electronIdx;   //!
   ...
   TBranch        *b_GenMET_pt;   //!
   //TBranch        *b_MET_MetUnclustEnUpDeltaX;   //! //Prompt 2024 data
   //TBranch        *b_MET_MetUnclustEnUpDeltaY;   //! //Prompt 2024 data
   //TBranch        *b_MET_covXX;   //! //Prompt 2024 data
   //TBranch        *b_MET_covXY;   //! //Prompt 2024 data
   //TBranch        *b_MET_covYY;   //! //Prompt 2024 data
   //TBranch        *b_MET_phi;   //! //Prompt 2024 data
   TBranch        *b_MET_pt;   //!  //Prompt 2024 data
   //TBranch        *b_MET_significance;   //! //Prompt 2024 data
   TBranch        *b_MET_sumEt;   //! //Prompt 2024 data
   //TBranch        *b_MET_sumPtUnclustered;   //! //Prompt 2024 data
   TBranch        *b_nMuon;   //!
   TBranch        *b_Muon_dxy;   //!
  ...
  //TBranch        *b_Photon_z_calo;   //!
   ...
   //TBranch        *b_PuppiMET_phiJERDown;   //! //Prompt 2024 data
   //TBranch        *b_PuppiMET_phiJERUp;   //! //Prompt 2024 data
   //TBranch        *b_PuppiMET_phiJESDown;   //! //Prompt 2024 data
   //TBranch        *b_PuppiMET_phiJESUp;   //! //Prompt 2024 data
   TBranch        *b_PuppiMET_phiUnclusteredDown;   //!
   TBranch        *b_PuppiMET_phiUnclusteredUp;   //!
   TBranch        *b_PuppiMET_pt;   //!
   //TBranch        *b_PuppiMET_ptJERDown;   //! //Prompt 2024 data
   //TBranch        *b_PuppiMET_ptJERUp;   //! //Prompt 2024 data
   //TBranch        *b_PuppiMET_ptJESDown;   //! //Prompt 2024 data
   //TBranch        *b_PuppiMET_ptJESUp;   //! //Prompt 2024 data
   TBranch        *b_PuppiMET_ptUnclusteredDown;   //!
   TBranch        *b_PuppiMET_ptUnclusteredUp;   //!
   TBranch        *b_PuppiMET_sumEt;   //!
   //TBranch        *b_RawMET_phi;   //! //Prompt 2024 data
   //TBranch        *b_RawMET_pt;   //! //Prompt 2024 data
   //TBranch        *b_RawMET_sumEt;   //! //Prompt 2024 data
   TBranch        *b_RawPuppiMET_phi;   //!
   TBranch        *b_RawPuppiMET_pt;   //!
   TBranch        *b_RawPuppiMET_sumEt;   //! Prompt 2024 data, to reduce possible noise. Nestor.
  ...
  //TBranch        *b_Tau_idDeepTau2018v2p5VSmu;   //!
   //TBranch        *b_TkMET_phi;   //! //Prompt 2024 data
   //TBranch        *b_TkMET_pt;   //! //Prompt 2024 data
   //TBranch        *b_TkMET_sumEt;   //! //Prompt 2024 data
   TBranch        *b_nTrigObj;   //!
...
void DijetHistosFill::Init(TTree *tree)
{
   ...
   if (isRun2) fChain->SetBranchAddress("ChsMET_phi", &ChsMET_phi, &b_ChsMET_phi);
   if (isRun2) fChain->SetBranchAddress("ChsMET_pt", &ChsMET_pt, &b_ChsMET_pt);
   //fChain->SetBranchAddress("ChsMET_phi", &ChsMET_phi, &b_ChsMET_phi); //Prompt 2024 data
   //fChain->SetBranchAddress("ChsMET_pt", &ChsMET_pt, &b_ChsMET_pt); //Prompt 2024 data
   //fChain->SetBranchAddress("ChsMET_sumEt", &ChsMET_sumEt, &b_ChsMET_sumEt); //Prompt 2024 data
   ...
   //fChain->SetBranchAddress("Electron_mvaTTH", Electron_mvaTTH, &b_Electron_mvaTTH); // Not in 2024C. Nestor. April 17, 2024.
   ...
   */
   ...
   //fChain->SetBranchAddress("MET_MetUnclustEnUpDeltaX", &MET_MetUnclustEnUpDeltaX, &b_MET_MetUnclustEnUpDeltaX); //Prompt 2024 data
   //fChain->SetBranchAddress("MET_MetUnclustEnUpDeltaY", &MET_MetUnclustEnUpDeltaY, &b_MET_MetUnclustEnUpDeltaY); //Prompt 2024 data
   //fChain->SetBranchAddress("MET_covXX", &MET_covXX, &b_MET_covXX); //Prompt 2024 data
   //fChain->SetBranchAddress("MET_covXY", &MET_covXY, &b_MET_covXY); //Prompt 2024 data
   //fChain->SetBranchAddress("MET_covYY", &MET_covYY, &b_MET_covYY); //Prompt 2024 data
   //fChain->SetBranchAddress("MET_phi", &MET_phi, &b_MET_phi); //Prompt 2024 data
   //fChain->SetBranchAddress("MET_pt", &MET_pt, &b_MET_pt); //Prompt 2024 data
   //fChain->SetBranchAddress("MET_significance", &MET_significance, &b_MET_significance); //Prompt 2024 data
   //fChain->SetBranchAddress("MET_sumEt", &MET_sumEt, &b_MET_sumEt); //Prompt 2024 data
   //fChain->SetBranchAddress("MET_sumPtUnclustered", &MET_sumPtUnclustered, &b_MET_sumPtUnclustered); //Prompt 2024 data
   ...
   //fChain->SetBranchAddress("Muon_mvaTTH", Muon_mvaTTH, &b_Muon_mvaTTH); //Not included in 2024C. Nestor. April 17, 2024.
   ...
   //fChain->SetBranchAddress("PuppiMET_phiJERDown", &PuppiMET_phiJERDown, &b_PuppiMET_phiJERDown); //Prompt 2024 data
   //fChain->SetBranchAddress("PuppiMET_phiJERUp", &PuppiMET_phiJERUp, &b_PuppiMET_phiJERUp); //Prompt 2024 data
   //fChain->SetBranchAddress("PuppiMET_phiJESDown", &PuppiMET_phiJESDown, &b_PuppiMET_phiJESDown); //Prompt 2024 data
   //fChain->SetBranchAddress("PuppiMET_phiJESUp", &PuppiMET_phiJESUp, &b_PuppiMET_phiJESUp); //Prompt 2024 data
   ...
   //fChain->SetBranchAddress("PuppiMET_ptJERDown", &PuppiMET_ptJERDown, &b_PuppiMET_ptJERDown); //Prompt 2024 data
   //fChain->SetBranchAddress("PuppiMET_ptJERUp", &PuppiMET_ptJERUp, &b_PuppiMET_ptJERUp); //Promot 2024 data
   //fChain->SetBranchAddress("PuppiMET_ptJESDown", &PuppiMET_ptJESDown, &b_PuppiMET_ptJESDown); //Prompt 2024 data
   //fChain->SetBranchAddress("PuppiMET_ptJESUp", &PuppiMET_ptJESUp, &b_PuppiMET_ptJESUp); //Prompt 2024 data
   ...
   //fChain->SetBranchAddress("RawMET_phi", &RawMET_phi, &b_RawMET_phi); //Prompt 2024 data
   //fChain->SetBranchAddress("RawMET_pt", &RawMET_pt, &b_RawMET_pt); //Prompt 2024 data
   //fChain->SetBranchAddress("RawMET_sumEt", &RawMET_sumEt, &b_RawMET_sumEt); //Prompt 2024 data
   ...
   //fChain->SetBranchAddress("TkMET_phi", &TkMET_phi, &b_TkMET_phi); //Prompt 2024 data
   //fChain->SetBranchAddress("TkMET_pt", &TkMET_pt, &b_TkMET_pt); //Prompt 2024 data
   //fChain->SetBranchAddress("TkMET_sumEt", &TkMET_sumEt, &b_TkMET_sumEt); //Prompt 2024 data
